import { Card, Center, Divider, Text, TextInput, Group, Space, Button, Modal, Select, UnstyledButton, Textarea } from "@mantine/core";
...
export default function AddStationForm() {
    ...
    const handleStationSubmit = async (event) => {
        ...
        console.log(buildStationRequest)
        ...
        const response = await fetch('http://localhost:8080/api/v1/stations/add', requestOptions)
        ...
        <Center>
            <div style={{ width: '96%', margin: 'auto' }}>
                <Card shadow="sm" p="lg">
                    <Card.Section>
                        <Center>
                            <Text className="text-3xl font-bold my-3">Add Station</Text>
                        </Center>
                    </Card.Section>
                    <Divider />
                    <Card.Section>
                        ...
                        <Group className="my-2 ml-6">
                            <TextInput
                                label="Code:" value={stationCode} required onChange={(event) => setStationCode(event.currentTarget.value)}
                            />
                        </Group>
                        <Group className="my-2 ml-6">
                            <TextInput
                                label="Name:" value={stationName} required onChange={(event) => setStationName(event.currentTarget.value)}
                            />
                        </Group>
                        <Group className="my-2 ml-6">
                            <Textarea

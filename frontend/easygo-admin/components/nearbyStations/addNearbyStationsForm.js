...
export default function AddNearbyStationsForm() {
    ...
    const handleNearbyStationSubmit = async (event) => {
        ...
        const response = await fetch('http://localhost:8080/api/v1/nearbyStations/add', requestOptions)
                ...
                <Card shadow="sm" p="lg">
                    ...
                    <Card.Section>
                        ...
                        <Group className="my-2 ml-6">
                            <TextInput
                                label="Extension Code:" value={extendedStationCode} required onChange={(event) => setExtendedStationCode(event.currentTarget.value)}
                            />
                        </Group>
                        <Group className="my-2 ml-6">
                            <Select

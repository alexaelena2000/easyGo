...
export default function AddTripForm() {
    ...
    const handleTripSubmit = async (event) => {
        ...
        const response = await fetch('http://localhost:8080/api/v1/trips/add', requestOptions)
        ...
        <Center>
            <div style={{ width: '96%', margin: 'auto' }}>
                <Card shadow="sm" p="lg">
                    <Card.Section>
                        <Center>
                            <Text className="text-3xl font-bold my-3">Add Trip</Text>
                        </Center>
                    </Card.Section>
                    <Divider />
                    <Card.Section>
                        ...
                        <Group className="my-2 ml-6">
                            <TextInput
                                label="Code:" value={tripCode} required onChange={(event) => setTripCode(event.currentTarget.value)}
                            />
                        </Group>
                        <Group className="my-2 ml-6">
                            <Select
                            ...
                            />
                            <TimeInput label="Departure Time:" required style={{ width: '120px' }} onChange={setTripDepartureTime} />
                        </Group>
                        <Group className="my-2 ml-6">
                            <Select
                            ...
                            />
                            <TimeInput label="Arrival Time:" required style={{ width: '120px' }} onChange={setTripArrivalTime} />
                        </Group>
                        <Group className="my-2 ml-6">
                            <TextInput
